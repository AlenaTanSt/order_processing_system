...
int main(int argc, char* argv[]) {
    // По умолчанию обрабатываем 5 заказов
    std::size_t orders_count = 500;

    // Один необязательный аргумент: количество заказов
    if (argc == 2) {
        try {
    ...
    // Генерация уникальных идентификаторов в рамках запуска
    ...
    // Последовательная обработка всех заказов
